...
${nuget_cmd} install src/Obada.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Obada.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Obada.Client.dll \
-recurse:'src/Obada.Client/*.cs' \
-doc:bin/Obada.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Obada.Client.dll was created successfully"
fi
