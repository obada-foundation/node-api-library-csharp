...
namespace Obada.Client.Model
{
    ...
    public partial class DocumentLink :  IEquatable<DocumentLink>, IValidatableObject
    {
        ...
        public DocumentLink(string name = default(string), string hashlink = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DocumentLink and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (hashlink == null)
            {
                throw new InvalidDataException("hashlink is a required property for DocumentLink and cannot be null");
            }
            else
            {
